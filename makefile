...
#Setup build flags
FLAG_NAMES += CONFIG_SHELL_BUFFER CONFIG_FAT_DEBUG CONFIG_FAT_POOLS CONFIG_FAT_THREADS CONFIG_FAT_TIME
FLAG_NAMES += CONFIG_FAT_UNICODE CONFIG_FAT_WRITE CONFIG_CRYPTO CONFIG_MMI_DEBUG CONFIG_MMI_STATUS
